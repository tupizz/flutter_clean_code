...
import './../../../../../lib/core/plataform/network_info.dart';
...
import './../../../../../lib/features/number_trivia/data/datasources/number_trivia_local_datasource.dart';
import './../../../../../lib/features/number_trivia/data/datasources/number_trivia_remote_datasource.dart';
...
void main() {
  ...
  void runTestsOnline(Function fn) {
  ...
  void runTestsOffline(Function fn) {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test('should return server failure when the call to remote data source in unsuccessful', () async {
        // arrange
    ...
    runTestsOffline(() {
      test('should return last locally cached data when the data is present', () async {
        // arrange
      ...
      test('should return cache failure when there is no data present in cache', () async {
        // arrange
